...
router.get('/business/:businessId', authMiddleware, validateBusinessId, getProjectsByBusinessId);

router.get('/business/:businessId/stats', authMiddleware, validateBusinessId, getProjectStats);
