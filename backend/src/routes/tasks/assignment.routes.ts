...
router.get('/:taskId', validateRequest(taskIdSchema), assignmentController.getAssignmentsByTaskId);
...
router.delete('/:taskId', validateRequest(taskIdSchema), assignmentController.removeAllAssignments);
